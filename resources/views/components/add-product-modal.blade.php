<dialog id="add_product" class="modal">
    <div class="modal-box">
        ...
        <h3 class="font-bold text-2xl">Add Product</h3>
        <form action="/dashboard/laptop/add" method="post" class="mt-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <button type="submit" class="w-full bg-red-600 py-2 rounded-md text-white">Add</button>
        </form>
    </div>
</dialog>
